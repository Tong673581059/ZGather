 ...
 */
public abstract class BaseSkinFragment extends BaseFrameFrag implements IDynamicNewView {
            ...
            if (clickArray != null && clickArray.value().length > 0) {
                ...
                for (int click : clickArray.value()) {
                    ...
                    view.setOnClickListener(v -> {
                        try {
                            if (isHasParam) {
                                method.invoke(BaseSkinFragment.this, view);
                            } else {
                                method.invoke(BaseSkinFragment.this);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
